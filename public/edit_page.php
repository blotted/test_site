...
<div id="main">
    ...
    <div id="page">
        ...
        <form action="edit_page.php?page=<?php echo urlencode($current_page["id"]); ?>" method="post">
            ...
            <p>Content:<br />
                <textarea name="content" rows="15" cols="85" wrap="hard"><?php echo htmlentities($current_page["content"]); ?></textarea>
            </p>
...
urlencode($current_page["id"]); ?>" onclick="return confirm('Are you sure?');">Delete page</a>
    </div>			
</div>
